...
# ADDENDUM
All credit goes to [milaq](https://github.com/milaq/libstrangle) for creating this.  
...
void* real_dlsym(void* handle, const char* name)
{
    ...
    if (the_real_dlsym == NULL) 
    {
        ...
        the_real_dlsym = (void* (*)(void*, const char*)) dlvsym(libdl, "dlsym", "GLIBC_2.2.5");

        if (!the_real_dlsym) 
        {
        	the_real_dlsym = (void* (*)(void*, const char*)) dlsym(RTLD_NEXT, "dlsym");
        }
    }
